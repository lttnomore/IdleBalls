...
class Ball(Sprite):
    ...
    def check_screen_collisions(self):
        ...
        elif self.position.x > commons.game_field_w - self.radius:
            self.position.x = commons.game_field_w - self.radius

        if self.position.x <= self.radius or self.position.x >= commons.game_field_w - self.radius:
